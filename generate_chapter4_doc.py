...
SRC = Path("results") / "thesis_draft" / "第四章_分解法(两阶段)求解框架设计与实现.txt"
OUT = Path("results") / "thesis_draft" / "第四章_分解法(两阶段)求解框架设计与实现_规范排版版.docx"
...
def build_doc():
    ...
    hrun = hp.add_run("东北大学本科生毕业设计（论文）\t4 分解法(两阶段)求解框架设计与实现")
